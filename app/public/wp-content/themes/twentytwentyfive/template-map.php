...
<div class="map-page" dir="rtl">
    ...
    <div id="project-panel" class="project-panel" role="dialog" aria-modal="true" aria-hidden="true" dir="rtl">
        <div class="project-panel-inner">
            ...
            <div class="project-images-section hidden" id="project-images"></div>

            <div class="project-panel-divider"></div>

            <div class="project-panel-meta">
                <div class="project-meta-row hidden" id="pm-location">
...
<div class="map-logo">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="קרן שותפות">
</div>
