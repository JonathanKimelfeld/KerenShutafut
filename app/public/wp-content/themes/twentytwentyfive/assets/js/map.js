...
(function () {
    ...
    const TRANSLATIONS = {
        ...
        ar: {
            panelTitle:           'خريطة صندوق الشراكة',
            panelDescription:     'أمامك خريطة تُظهر انتشار المبادرات التي تدعمها <strong>صندوق الشراكة</strong>. تعمل هذه المبادرات على تعزيز المجتمع المشترك وقيم التعايش بين المجموعات المختلفة التي تُشكّل المجتمع الإسرائيلي.<br>تُبيّن المبادرات في عملها تنوّع الأساليب الأصيلة والمثيرة للاهتمام في تعزيز التسامح والمساواة وحياة الشراكة في إسرائيل.',
